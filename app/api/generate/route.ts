...
- 상권/거리: "경주 황리단길", "강릉 안목해변" 처럼 지역명 + 공식 장소명
- 박물관·공원·시설: "국립경주박물관", "참소리축음기&에디슨과학박물관" 등 공식 등록명 그대로 (특수문자 포함)
- 숙소: 실제 숙소 상호명 또는 "경주시 황남동" 처럼 행정동명
- 자차 이동: IC·나들목 명칭 절대 금지 — "강릉시", "안양시 만안구" 처럼 행정구역명만 사용
- ~마을 접미사 금지: "초당순두부마을" 대신 "강릉 초당동" 처럼 행정동명 사용
- 절대 금지: 구어체·비공식 명칭, 모호한 표현 ("근처 식당"), 존재하지 않는 장소명
- 식당은 특정 식당명 대신 해당 지역 상권명으로 대체 (예: "경주 황리단길")
